...
Filename    :   REV_StereoProjection.cpp
                           ...
                           bool flipZ /*= false*/, bool farAtInfinity /*= false*/)
{
    ...
    {
        //REV_ASSERT_M(false, "Cannot push Far Clip to Infinity when Z-order is not flipped"); Assertion disabled because this code no longer has access to LibOVRKernel assertion functionality.
        farAtInfinity = false;
    }
